...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<div class="entry-meta">
			<span class="cat-links">Categorized Under: <?php echo get_the_category_list( _x( ', ', 'Used between list items, there is a space after the comma.', 'abledtwentyfourteen' ) ); ?></span>
		</div>
		<?php
			endif;
